...
import {homepagesomenumbersTS} from './homepagesomenumbers';
...
@Component({
  moduleId: module.id,
  selector: 'sd-homepagesomenumbers',
  templateUrl: 'homepagesomenumbers.component.html',
  styleUrls: ['homepagesomenumbers.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class HomepagesomenumbersComponent implements OnInit {
  ...
  msgs: Message[]=[];
   ...
   objVar: homepagesomenumbersTS;
   selectedRow:  homepagesomenumbersTS;

   objList:homepagesomenumbersTS[]=[];
  ...
  fileupload: FileUpload;
   ...
   isnewobj:boolean=false;
      ...
      clear(){
            this.isnewobj=true;
            this.objVar=new homepagesomenumbersTS();
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: HomepagesomenumbersService,
 ...
 onRowSelecthomepagesomenumbers(event: any){

this.isnewobj=false;
 let temphomepagedescriptionimg:homepagesomenumbersTS;
 temphomepagedescriptionimg=this.selectedRow;

//this.ngModelHpdiId= temphomepagedescriptionimg.HpdiId;

this.localService.edit(temphomepagedescriptionimg.HpsnId).subscribe(
p => this.objVar=p,
 e => console.log( e), 
 () => console.log("edit") );
...
{ 
  this.clear();
  this.userform = this.fb.group({'HpsnMainTitle':new FormControl('', Validators. required),'HpsnFirstTitle':new FormControl('', Validators. required),'HpsnFirstNos':new FormControl('', Validators. required),'HpsnSecondTitle':new FormControl('', Validators. required),'HpsnSecondNos':new FormControl('', Validators. required),'HpsnThirdTitle':new FormControl('', Validators. required),'HpsnThirdNos':new FormControl('', Validators. required),});
  ...
  this.localService
    ...
    deleteRow(cont: homepagesomenumbersTS) {
      ...
      this.confirmationService.confirm({
            ...
            let selectedkeywordgridRow:homepagesomenumbersTS=cont;
            this.objList.splice(this.findSelectedKeywordSubcatIndex(selectedkeywordgridRow), 1);
            cont = null;

 let deleted:boolean=false;
            this.baseUrlservice.callCommonDeleteWS('homepagesomenumbers','HpsnId',selectedkeywordgridRow.HpsnId)
              .subscribe(
              p => deleted=p,
              e => console.log( e),
              () => {
  ...
  findSelectedKeywordSubcatIndex(p:homepagesomenumbersTS): number {
