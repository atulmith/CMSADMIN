...
import {aboutusboardmembersTS} from './aboutusboardmembers';
...
@Component({
  moduleId: module.id,
  selector: 'sd-aboutusboardmembers',
  templateUrl: 'aboutusboardmembers.component.html',
  styleUrls: ['aboutusboardmembers.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class AboutusboardmembersComponent implements OnInit {
  ...
  msgs: Message[]=[];
   ...
   objVar: aboutusboardmembersTS;
   selectedRow:  aboutusboardmembersTS;

   objList:aboutusboardmembersTS[]=[];
  ...
  fileupload: FileUpload;
   ...
   isnewobj:boolean=false;
      ...
      clear(){
            this.isnewobj=true;
            this.objVar=new aboutusboardmembersTS();
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: AboutusboardmembersService,
 ...
 onRowSelectaboutusboardmembers(event: any){

this.isnewobj=false;
 let temphomepagedescriptionimg:aboutusboardmembersTS;
 temphomepagedescriptionimg=this.selectedRow;

//this.ngModelHpdiId= temphomepagedescriptionimg.HpdiId;

this.localService.edit(temphomepagedescriptionimg.AbmId).subscribe(
p => this.objVar=p,
 e => console.log( e), 
 () => console.log("edit") );
...
{ 
    ...
    this.userform = this.fb.group({'AbmName':new FormControl('', Validators. required),'AbmPosition':new FormControl('', Validators. required),'AbmSrNo':new FormControl('', Validators. required),});
    ...
    deleteRow(cont: aboutusboardmembersTS) {
      ...
      this.confirmationService.confirm({
            ...
            let selectedkeywordgridRow:aboutusboardmembersTS=cont;
            this.objList.splice(this.findSelectedKeywordSubcatIndex(selectedkeywordgridRow), 1);
            cont = null;
             let deleted:boolean=false;
             this.baseUrlservice.callCommonDeleteWS('aboutusboardmembers','AbmId',selectedkeywordgridRow.AbmId)
              .subscribe(
              p => deleted=p,
              e => console.log( e),
              () => {
  ...
  findSelectedKeywordSubcatIndex(p:aboutusboardmembersTS): number {
