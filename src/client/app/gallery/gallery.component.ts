...
export class GalleryComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: GalleryService,
 ...
 onRowSelectgallery(event: any){

this.isnewobj=false;
 let temphomepagedescriptionimg:galleryTS;
 temphomepagedescriptionimg=this.selectedRow;

//this.ngModelHpdiId= temphomepagedescriptionimg.HpdiId;

this.localService.edit(temphomepagedescriptionimg.GalleryId).subscribe(
p => this.objVar=p,
 e => console.log( e), 
 () => console.log("edit") );
...
{ 
  this.clear();
  this.userform = this.fb.group({'GalleryTitle':new FormControl('', Validators. required),'GallerySrNo':new FormControl('', Validators. required),'filename':new FormControl('', Validators. required),'GalleryType':new FormControl('', Validators. required),});
  ...
  this.localService
    ...
    deleteRow(cont: galleryTS) {
      ...
      this.confirmationService.confirm({
            ...
            let selectedkeywordgridRow:galleryTS=cont;
            this.objList.splice(this.findSelectedKeywordSubcatIndex(selectedkeywordgridRow), 1);
            cont = null;
            
 let deleted:boolean=false;
            this.baseUrlservice.callCommonDeleteWS('gallery','GalleryId',selectedkeywordgridRow.GalleryId)
              .subscribe(
              p => deleted=p,
              e => console.log( e),
              () => {
  ...
  findSelectedKeywordSubcatIndex(p:galleryTS): number {
