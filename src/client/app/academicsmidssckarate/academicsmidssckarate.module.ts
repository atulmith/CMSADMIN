...
import { AcademicsmidssckarateRoutingModule } from './academicsmidssckarate-routing.module';
...
@NgModule({
  imports: [CommonModule, InputTextareaModule,EditorModule,ConfirmDialogModule,AutoCompleteModule,FileUploadModule,DropdownModule,CalendarModule,AcademicsmidssckarateRoutingModule,FormsModule,DataTableModule,ReactiveFormsModule,InputTextModule,GrowlModule,ButtonModule,PanelModule,MessagesModule],//,PanelModule,MessagesModule,Growl],
  declarations: [AcademicsmidssckarateComponent],
  exports: [AcademicsmidssckarateComponent],
  providers: [AcademicsmidssckarateService,ConfirmationService]
})
export class AcademicsmidssckarateModule { }
