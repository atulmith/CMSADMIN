...
import { AcademicsschoolactivitiesService } from './academicsschoolactivities.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AcademicsschoolactivitiesService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          AcademicsschoolactivitiesService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  AcademicsschoolactivitiesService);
