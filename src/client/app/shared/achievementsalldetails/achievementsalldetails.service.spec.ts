...
import { AchievementsalldetailsService } from './achievementsalldetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AchievementsalldetailsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AchievementsalldetailsService);
