...
import { AboutusboardmembersService } from './aboutusboardmembers.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AboutusboardmembersService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AboutusboardmembersService);
