...
import { PrincipaldeskService } from './principaldesk.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: PrincipaldeskService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  PrincipaldeskService);
