...
import { AcademicspriprimaryService } from './academicspriprimary.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AcademicspriprimaryService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AcademicspriprimaryService);
