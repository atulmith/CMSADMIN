...
import { AcademicsmidssckarateService } from './academicsmidssckarate.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AcademicsmidssckarateService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AcademicsmidssckarateService);
