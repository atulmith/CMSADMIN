...
import { AchivementsgraphsService } from './achivementsgraphs.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AchivementsgraphsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AchivementsgraphsService);
