...
import { HomepagesomenumbersService } from './homepagesomenumbers.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagesomenumbersService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagesomenumbersService);
