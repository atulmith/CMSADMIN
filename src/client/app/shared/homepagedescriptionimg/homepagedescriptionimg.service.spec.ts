...
import { HomepagedescriptionimgService } from './homepagedescriptionimg.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagedescriptionimgService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagedescriptionimgService);
