...
import { HomepagelatestnewsService } from './homepagelatestnews.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagelatestnewsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagelatestnewsService);
