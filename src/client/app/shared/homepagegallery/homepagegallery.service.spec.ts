...
import { HomepagegalleryService } from './homepagegallery.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagegalleryService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagegalleryService);
