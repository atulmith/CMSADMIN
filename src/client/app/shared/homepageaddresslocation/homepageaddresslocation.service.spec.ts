...
import { HomepageaddresslocationService } from './homepageaddresslocation.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepageaddresslocationService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          HomepageaddresslocationService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  HomepageaddresslocationService);
