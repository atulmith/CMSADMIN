...
import { HomepagessctoppersService } from './homepagessctoppers.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagessctoppersService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagessctoppersService);
