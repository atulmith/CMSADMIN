...
import { HomepageschoolresultsService } from './homepageschoolresults.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepageschoolresultsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepageschoolresultsService);
