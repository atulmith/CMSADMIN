...
import { AcademistopstudteachersdetailsService } from './academistopstudteachersdetails.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AcademistopstudteachersdetailsService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          AcademistopstudteachersdetailsService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  AcademistopstudteachersdetailsService);
