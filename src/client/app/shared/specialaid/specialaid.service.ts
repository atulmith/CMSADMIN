...
import { specialaidTS} from '../../specialaid/specialaid';
import {tbl_uploadedfile_masterTS} from '../../specialaid/tbl_uploadedfile_masterTS';
 ...
 */
@Injectable()
export class SpecialaidService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'specialaid/';
...
insert(inparam0: string): Observable<specialaidTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_specialaid_create`;
...
update(inparam0: string): Observable<specialaidTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_specialaid_update`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
getall(inparam0: string): Observable<specialaidTS[]>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_specialaid_selectjson`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
edit(inparam0: string): Observable<specialaidTS>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_specialaid_selectedit`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
