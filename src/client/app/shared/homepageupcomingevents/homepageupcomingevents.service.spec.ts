...
import { HomepageupcomingeventsService } from './homepageupcomingevents.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepageupcomingeventsService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepageupcomingeventsService);
