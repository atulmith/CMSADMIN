...
export class BaseUrlService {
  ...
  // private baseUrl: string = 'http://localhost:8080/AMARKORWS/rest/';
  private baseUrl: string = 'http://www.amarkor.com:8080/AMARKORWS/rest/';
  ...
  getBaseurl():string{
    return this.baseUrl;
     ...
     callCommonDeleteWS(tablename: string,pkid:string,pkvalue:string): Observable<any>{
    
        let headers1 = new Headers();
        
        headers1.append('Content-Type', 'application/x-www-form-urlencoded');
        var body1 = `tablename=${tablename}&pkid=${pkid}&pkvalue=${pkvalue}`;
        // var url2 = `${this.baseUrl}WS_achivementsgraphs_create`;
        var url2 = `${this.baseUrl}login/WS_common_delete`;
