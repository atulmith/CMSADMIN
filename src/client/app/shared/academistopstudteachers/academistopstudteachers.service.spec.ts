...
import { AcademistopstudteachersService } from './academistopstudteachers.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AcademistopstudteachersService;
    ...
    beforeEach(() => {
      ...
      let injector = ReflectiveInjector.resolveAndCreate([
          AcademistopstudteachersService,
        BaseRequestOptions,
        MockBackend,
        {provide: Http,
      ...
      nameListService = injector.get(  AcademistopstudteachersService);
