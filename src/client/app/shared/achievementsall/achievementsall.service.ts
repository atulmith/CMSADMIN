...
import {tbl_uploadedfile_masterTS} from '../../achievementsall/tbl_uploadedfile_masterTS';
 ...
 */
@Injectable()
export class AchievementsallService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'achievementsall/';
...
insert(inparam0: string): Observable<achievementsallTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_achievementsall_create`;
...
update(inparam0: string): Observable<achievementsallTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_achievementsall_update`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
getall(inparam0: string): Observable<achievementsallTS[]>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_achievementsall_selectjson`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
edit(inparam0: string): Observable<achievementsallTS>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_achievementsall_selectedit`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
