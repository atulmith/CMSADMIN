...
import { AchievementsallService } from './achievementsall.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: AchievementsallService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  AchievementsallService);
