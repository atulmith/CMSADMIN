...
import { newsannouncementTS} from '../../newsannouncement/newsannouncement';
import {tbl_uploadedfile_masterTS} from '../../newsannouncement/tbl_uploadedfile_masterTS';
...
export class NewsannouncementService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'newsannouncement/';
...
insert(inparam0: string): Observable<newsannouncementTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_newsannouncement_create`;
...
update(inparam0: string): Observable<newsannouncementTS[]>{
let headers1 = new Headers();
inparam0=encodeURIComponent(inparam0);
headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_newsannouncement_update`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
getall(inparam0: string): Observable<newsannouncementTS[]>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_newsannouncement_selectjson`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
...
edit(inparam0: string): Observable<newsannouncementTS>{
let headers1 = new Headers();

headers1.append('Content-Type', 'application/x-www-form-urlencoded');
var body1 = `input0=${ inparam0}`;
var url2 = `${this.baseUrl}WS_newsannouncement_selectedit`;
let returnval$ = this.http.post(url2 , body1 ,{headers: headers1})
.map((res:Response) => res.json()).catch(this.handleError);
return returnval$;
}
