...
import { HomepagevideourlService } from './homepagevideourl.service';

export function main() {
  describe('NameList Service', () => {
    let nameListService: HomepagevideourlService;
    ...
    beforeEach(() => {
      ...
      nameListService = injector.get(  HomepagevideourlService);
