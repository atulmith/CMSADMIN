...
import {homepagegalleryTS} from './homepagegallery';
...
@Component({
  moduleId: module.id,
  selector: 'sd-homepagegallery',
  templateUrl: 'homepagegallery.component.html',
  styleUrls: ['homepagegallery.component.css'],
  providers:[MyDateFormat,MyTimeFormat,BaseUrlService,ConfirmationService]
})
export class HomepagegalleryComponent implements OnInit {
  ...
  msgs: Message[]=[];
   ...
   objVar: homepagegalleryTS;
   selectedRow:  homepagegalleryTS;

   objList:homepagegalleryTS[]=[];
  ...
  fileupload: FileUpload;
   ...
   isnewobj:boolean=false;
      ...
      clear(){
            this.isnewobj=true;
            this.objVar=new homepagegalleryTS();
  ...
  constructor(private fb: FormBuilder,
              ...
              private localService: HomepagegalleryService,
 ...
 onRowSelecthomepagegallery(event: any){

this.isnewobj=false;
 let temphomepagedescriptionimg:homepagegalleryTS;
 temphomepagedescriptionimg=this.selectedRow;

//this.ngModelHpdiId= temphomepagedescriptionimg.HpdiId;

this.localService.edit(temphomepagedescriptionimg.HpgId).subscribe(
p => this.objVar=p,
 e => console.log( e), 
 () => console.log("edit") );
...
ngOnInit() 
{ this.clear();
this.userform = this.fb.group({'HpgTitle':new FormControl('', Validators. required),'HpgText':new FormControl('', Validators. required),'filename':new FormControl('', Validators. required),});
...
e => console.log( e),
 () => console.log('done getDisplayAll2' + JSON.stringify(this.objList)));
    ...
    deleteRow(cont: homepagegalleryTS) {
      ...
      this.confirmationService.confirm({
            ...
            let selectedkeywordgridRow:homepagegalleryTS=cont;
            this.objList.splice(this.findSelectedKeywordSubcatIndex(selectedkeywordgridRow), 1);
            cont = null;
            
 let deleted:boolean=false;
            this.baseUrlservice.callCommonDeleteWS('homepagegallery','HpgId',selectedkeywordgridRow.HpgId)
              .subscribe(
              p => deleted=p,
              e => console.log( e),
              () => {
  ...
  findSelectedKeywordSubcatIndex(p:homepagegalleryTS): number {
